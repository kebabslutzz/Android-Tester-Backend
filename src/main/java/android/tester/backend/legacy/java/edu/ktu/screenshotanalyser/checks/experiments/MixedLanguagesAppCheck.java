...
import android.tester.backend.legacy.java.edu.ktu.screenshotanalyser.checks.AppCheckResults;
import android.tester.backend.legacy.java.edu.ktu.screenshotanalyser.checks.AppDefectAnnotation;
import android.tester.backend.legacy.java.edu.ktu.screenshotanalyser.checks.BaseTextRuleCheck;
import android.tester.backend.legacy.java.edu.ktu.screenshotanalyser.checks.IAppRuleChecker;
