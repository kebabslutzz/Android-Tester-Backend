...
public class SystemContext {
  ...
  private final LazyObject<LanguageDetector> categorizer = new LazyObject<LanguageDetector>(() -> new LanguageDetectorME(new LanguageDetectorModel(getClass().getResourceAsStream("/langdetect-183.bin"))));
}
